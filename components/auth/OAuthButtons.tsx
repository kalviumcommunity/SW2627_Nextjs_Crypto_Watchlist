  ...
  return (
    ...
    <div className="flex flex-col gap-3 w-full">
      ...
      <button
        ...
        className="w-full h-[44px] bg-[#111827] border border-[#232B3A] rounded-lg flex items-center justify-center gap-3 text-sm font-semibold text-[#F5F6F8] hover:bg-[#1B2536] transition-colors focus:outline-none focus:ring-2 focus:ring-[#3B82F6] disabled:opacity-50 cursor-pointer"
      >

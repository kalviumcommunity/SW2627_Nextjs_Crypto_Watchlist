...
export default function TickerStrip({
  ...
  return (
    <div
      ...
      className="h-[36px] bg-[#10131C] border-b border-[#232B3A] px-3 sm:px-4 md:px-6 flex items-center justify-between text-[13px] text-[#9AA4B2] overflow-x-auto whitespace-nowrap scrollbar-none touch-pan-x"
    >
      {/* Metrics List */}
      <div className="flex items-center gap-3 sm:gap-4 md:gap-6 text-xs md:text-[13px] shrink-0 pr-4">
        {/* 24h Vol */}
        <div className="flex items-center gap-1.5 shrink-0">
          <span className="text-[#9AA4B2]">24h Vol:</span>
          <span className="text-white font-medium tabular-nums">{vol24h}</span>
        </div>
        <span className="text-[#232B3A] shrink-0" aria-hidden="true">·</span>
        ...
        <div className="flex items-center gap-1 text-[#1FB878] font-medium bg-[#0F3D30]/60 px-2 py-0.5 rounded text-xs shrink-0" aria-label={`Global Market 24h change ${globalMarketPct}`}>
      ...
      <div className="flex items-center gap-2 pl-4 text-xs md:text-[13px] shrink-0 border-l border-[#232B3A]/60 sm:border-l-0">

  ...
  if (!coin) {
    return (
      <div className="max-w-[1280px] mx-auto px-6 py-16 text-center">
        <h1 className="text-2xl font-bold text-white mb-3">Coin Not Found</h1>
        <p className="text-[#9AA4B2] text-sm mb-6">
          Could not find market data for asset symbol &quot;{upperSymbol}&quot;.
        </p>
        <Link
          href="/markets"
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#FF5446] hover:bg-[#D63A2F] text-white rounded-lg font-semibold text-sm transition-colors"
        >
